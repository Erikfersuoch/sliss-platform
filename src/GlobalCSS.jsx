...
const GlobalCSS = () => <style>{`
  *{margin:0;padding:0;box-sizing:border-box;font-family:'DM Sans','Apple Color Emoji','Segoe UI Emoji','Noto Color Emoji',sans-serif;overflow-wrap:break-word}
  ...
  input,textarea,select{font-family:inherit;background:${T.bg2};border:1.5px solid ${T.border};color:${T.text};border-radius:10px;padding:12px 14px;font-size:15px;outline:none;transition:border-color .2s;width:100%}
