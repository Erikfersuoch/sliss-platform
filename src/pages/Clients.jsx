...
const Clients = ({initialClientId,openAdd}) => {
  ...
  return (
    <div style={{animation:"fadeIn .35s ease"}}>
      ...
      {!filtered.length
        ? clients.length===0
          ? <Empty preview={<><GhostRow /><GhostRow /></>} previewLabel="la tua scheda cliente" title="I tuoi clienti vivranno qui" desc="Per ognuno, Sliss tiene la scheda e prepara i follow-up." action={<Btn onClick={()=>setShowNew(true)}>+ Aggiungi il primo cliente</Btn>} hint={<>oppure <button onClick={()=>setShowInvite(true)} style={{background:"none",border:"none",color:T.blue,fontWeight:600,cursor:"pointer",fontFamily:"inherit",fontSize:"12.5px",padding:0}}>invitalo con un link</button></>} />
