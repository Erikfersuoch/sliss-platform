...
const TopBar = ({view,setView}) => {
  const moreActive=["richieste","templates","feedback","modules","settings","help","more"].includes(view);
  return (
...
const MoreMenu = ({setView,bizType=""}) => {
  ...
  const items=[first,{id:"templates",icon:"file",label:"Template",desc:"Gestisci i messaggi"},{id:"feedback",icon:"star",label:"Feedback",desc:"Recensioni clienti"},{id:"modules",icon:"grid",label:"Moduli",desc:"Funzioni aggiuntive"},{id:"settings",icon:"settings",label:"Impostazioni",desc:"Personalizza Sliss"},{id:"help",icon:"message",label:"Aiuto",desc:"Come funziona Sliss"}];
  return (
...
const DesktopSidebar = ({view,setView}) => {
  ...
  const allNav=[...getNavMain(sData?.settings?.bizType||""),{id:"richieste",icon:"bell",label:"Richieste"},{id:"templates",icon:"file",label:"Template"},{id:"feedback",icon:"star",label:"Feedback"},{id:"modules",icon:"grid",label:"Moduli"},{id:"settings",icon:"settings",label:"Impostazioni"},{id:"help",icon:"message",label:"Aiuto"}];
  return (
