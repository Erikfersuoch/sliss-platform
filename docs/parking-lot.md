...
- [08/06/2026] **[⏸️ PARCHEGGIATO — PROSSIMA SESSIONE, brief pronto in `docs/prepara-scheda-redesign.md`] Redesign "Prepara scheda" → sotto CLIENTI.** Da feedback Moira: il flusso d'inserimento cliente (link consulenza → scheda in attesa → anagrafica) è legnoso/poco intuitivo. Decisione: spostarlo sotto Clienti con **linguaggio più umano**, **logica INVARIATA** (cliente e appuntamento restano separati di proposito; solo parole e posto, NON toccare il flusso). È una revisione UX → richiede **anteprima prima/dopo** da approvare. Da abbinare alla notifica novità per **Moira** (servizi) insieme al calendario. (Era il punto 3 del piano DEV 07/06; backup e calendario fatti l'08/06.)
